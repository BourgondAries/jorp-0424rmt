...
switch model_case
    ...
    case 9 % Extra 3.3
        Eta0 = [0; 0; 200; 0; 0; 0;]';
        WP = [Eta0(1) 30 100; Eta0(2) 5 60; Eta0(3) 145 150; Eta0(6) 160*deg2rad 320*deg2rad]'; %Marking the ends of each spline
        CS = cat(1,0,cumsum(sqrt(sum(diff(WP,[],1).^2,2))));
        dd = interp1(CS, WP, unique([CS(:)' linspace(0,CS(end),100)]),'pchip');
        time = 1000;
